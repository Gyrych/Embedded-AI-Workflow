...
class WorkflowPanel {
    ...
    async handleExportWorkflow(workflowJson) {
    ...
    async handleGenerateCode(workflowJson, platform) {
    ...
    async generateWithAi(workflowJson, platform) {
        try {
    ...
    async generateWithOpenAI(workflowJson, platform) {
        const config = vscode.workspace.getConfiguration('embedded-ai-workflow');
    ...
    async generateWithCustomHttp(workflowJson, platform) {
        const config = vscode.workspace.getConfiguration('embedded-ai-workflow');
    ...
    generateMockManifest(workflowJson, platform) {
    ...
    addPlatformBuildFiles(manifest, platform) {
