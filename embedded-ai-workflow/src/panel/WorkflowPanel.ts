...
export class WorkflowPanel {
	...
	private getHtmlForWebview(webview: vscode.Webview) {
		...
		const vueUri = webview.asWebviewUri(
			vscode.Uri.joinPath(this.extensionUri, 'media', 'vendor', 'vue.min.js')
		);
		const reteUri = webview.asWebviewUri(
			vscode.Uri.joinPath(this.extensionUri, 'media', 'vendor', 'rete.min.js')
		);
		const connectionPluginUri = webview.asWebviewUri(
			vscode.Uri.joinPath(this.extensionUri, 'media', 'vendor', 'connection-plugin.min.js')
		);
		const areaPluginUri = webview.asWebviewUri(
			vscode.Uri.joinPath(this.extensionUri, 'media', 'vendor', 'area-plugin.min.js')
		);
		const vueRenderPluginUri = webview.asWebviewUri(
			vscode.Uri.joinPath(this.extensionUri, 'media', 'vendor', 'vue-render-plugin.min.js')
		);
